...
class MultiBidMarket(gym.Env):
    ...
    def step(self, action):
        ...
        data = {
                'id': self.id,
                'label':self.label,
                #total capacity is the total energy generated by client and 'band' is used to seperate the total generated
                #energy into several parts with different bidding price
